...
try:
    gdf = gpd.read_file('data/SOCI_Accidentes_peligro.shp')
...
if risk_col not in gdf.columns:
    ...
    for level in levels:
        ...
        js_content = f"var json_Accidentes_{clean_level} = {json_data};"
        with open(f"data/riesgos/Accidentes_{clean_level}.js", "w", encoding="utf-8") as f:
            f.write(js_content)
        print(f"Saved data/riesgos/Accidentes_{clean_level}.js")
